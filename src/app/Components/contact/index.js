...
const Contact=()=>{
    return(
        <>
        <section className="py-10 bg-gray-100 sm:py-16 lg:py-24" id="contactus">
            ...
            <div className="grid grid-cols-1 gap-6 px-8 text-center md:px-0 md:grid-cols-3">
                ...
                <div className="overflow-hidden bg-white rounded-xl">
                    <div className="p-6">
                        ...
                        <p className="mt-6 text-lg font-medium mailto:text-gray-900">contact@example.com</p>
                        <p className="mt-1 text-lg font-medium mailto:text-gray-900">hr@example.com</p>
                    </div>
                </div>
                ...
                <div className="px-6 py-12 sm:p-12">
                    ...
                    <form action="#" method="POST" className="mt-14">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                            ...
                            <div className="sm:col-span-2">
                                <button type="submit" className="inline-flex items-center justify-center w-full px-4 py-4 mt-2 text-base font-semibold text-white transition-all duration-200 bg-black border border-transparent rounded-md focus:outline-none hover:bg-blue-700 focus:bg-blue-700">
                                    Send
                                </button>
                            </div>
                        </div>
